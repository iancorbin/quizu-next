...
export function Footer() {
  return (
    <footer style={{ background: "var(--gray-900)", color: "var(--gray-500)" }}>
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-4 gap-10">
          <div>
            ...
            <p className="mt-3 text-xs leading-relaxed" style={{ color: "var(--gray-600)", maxWidth: "200px" }}>
              Personality quizzes, trivia, polls. Play, earn, level up.
            </p>
          </div>
          <div>
            <p className="mono text-[10px] font-bold tracking-widest mb-3" style={{ color: "var(--gray-600)" }}>PLAY</p>
          ...
          <div>
            <p className="mono text-[10px] font-bold tracking-widest mb-3" style={{ color: "var(--gray-600)" }}>TOPICS</p>
            <div className="space-y-2 text-sm">
          ...
          <div>
            <p className="mono text-[10px] font-bold tracking-widest mb-3" style={{ color: "var(--gray-600)" }}>EARN</p>
            <div className="space-y-2 text-sm">
        ...
        <div className="mt-12 pt-6 flex items-center justify-between" style={{ borderTop: "1px solid rgba(255,255,255,0.06)" }}>
          <p className="mono text-[10px]" style={{ color: "var(--gray-600)" }}>&copy; {new Date().getFullYear()} Quizu</p>
