...
export function Footer() {
  return (
    <footer style={{ background: "var(--warm-900)", color: "var(--warm-500)" }}>
      ...
      <div className="mx-auto max-w-7xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="grid sm:grid-cols-4 gap-10">
          <div>
            ...
            <p className="mt-3 text-xs leading-relaxed" style={{ color: "var(--warm-600)", maxWidth: "200px" }}>
              Personality quizzes, trivia, polls. Discover yourself.
            </p>
          </div>
          <div>
            <p className="code text-[10px] font-bold tracking-widest mb-3" style={{ color: "var(--warm-600)" }}>QUIZZES</p>
          ...
          <div>
            <p className="code text-[10px] font-bold tracking-widest mb-3" style={{ color: "var(--warm-600)" }}>TOPICS</p>
            <div className="space-y-2 text-sm">
          ...
          <div>
            <p className="code text-[10px] font-bold tracking-widest mb-3" style={{ color: "var(--warm-600)" }}>MORE</p>
            <div className="space-y-2 text-sm">
        ...
        <div className="mt-12 pt-6 flex items-center justify-between" style={{ borderTop: "1px solid var(--warm-800)" }}>
          <p className="code text-[10px]" style={{ color: "var(--warm-600)" }}>&copy; {new Date().getFullYear()} Quizu</p>
